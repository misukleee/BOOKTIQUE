							    ...
							    <div class="prod_area horizontal">
							        ...
							        <div class="prod_info_box">
							            ...
							            <span class="prod_author">
							                ...
							                <span class="date"> · <fmt:formatDate value="${book.bookDate}" pattern="yyyy.MM.dd"/></span>
							            </span>
							            <div class="prod_price">
							                <span class="percent">${book.discountRate}%</span>
							                <span class="price">
							                    <span class="val"><fmt:formatNumber value="${book.discountPrice}" pattern="#,###"/></span>
							                    <span class="unit">원</span>
							                </span>
							                <span class="price_normal">
							                    <span class="text">정가</span>
							                    <s class="val"><fmt:formatNumber value="${book.bookPrice}" pattern="#,###"/>원</s>
							                </span>
							            </div>
