...
public class Crawling {
	...
	public static String WEB_DRIVER_PATH = "C:/Users/PC-12/chromedriver-win64/chromedriver.exe"; // 크롬드라이버 위치
	...
	public Crawling (){
		...
		url = "https://tickets.interpark.com/contents/genre/play";	// 크롤링 할 페이지 경로
	...
	public void activateBot() {
		...
		try {
			...
			// 4. 전체 탭 클릭
			element = driver.findElement(By.xpath("/html/body/div[1]/div/main/article[5]/section/div[2]/div[1]/div[1]/button[1]"));
