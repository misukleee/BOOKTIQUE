...
public class RegisterMail implements MailServiceInter {
    ...
    public MimeMessage creatMessage(String to) throws MessagingException, UnsupportedEncodingException {
        ...
        message.setSubject("[BOOKTIQUE] 비밀번호 변경을 위한 이메일 인증코드 입니다"); // 이메일 제목

        String msgg = "";
        // msgg += "<img src=../resources/static/image/emailheader.jpg />"; // header image
        msgg += "<h1>안녕하세요</h1>";
        msgg += "<h1>그룹웨어 BOOKTIQUE 입니다</h1>";
        msgg += "<br>";
        ...
        message.setFrom(new InternetAddress("rosy_h@naver.com", "Booktique_Admin"));
